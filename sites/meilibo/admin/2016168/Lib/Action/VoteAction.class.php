...
class VoteAction extends Action {
    ...
    public function do_add_voteuser(){
        ...
        if(!$upload->upload()) {
            ...
            $avatorpath = '/style/vote/'.$prefix.'/'.$uploadList[0]['savename'];
        }
    ...
    public function save_voterollpic()
    {
        ...
        if(!$upload->upload()) {
            ...
            $uploadList = $upload->getUploadFileInfo();
            $rollpicpath = '/style/vote/'.$prefix.'/'.$uploadList[0]['savename'];
        }
    ...
    public function save_votepartner()
    {
        ...
        if(!$upload->upload()) {
            ...
            $uploadList = $upload->getUploadFileInfo();
            $partnerpicpath = '/style/vote/'.$prefix.'/'.$uploadList[0]['savename'];
        }
