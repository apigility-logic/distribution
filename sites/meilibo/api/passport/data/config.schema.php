<?php 
define('UC_DBHOST', "#{meilibo.WEB.DBHOST}");
define('UC_DBUSER', "#{meilibo.WEB.DBUSER}");
define('UC_DBPW', "#{meilibo.WEB.DBPWD}");
define('UC_DBNAME', "#{meilibo.WEB.DBNAME}");
...
define('UC_KEY', '7p4Cfz0g5Mdt5A6Qcc75421q3VaHcQbf757r0AaVf7feb97W85flab4n2t7o7s44');
