...
<style>
html, body{margin:0; padding:0; border:0 none;font:14px Tahoma,Verdana;line-height:150%;}
...
<body style="background:url(/style/statics/images/hbg.jpg) no-repeat center #dff1f4;position:relative;top:-10px;left:0;">
<div class="message">
    <div class="msg">
    ...
    <div class="tip" style="padding-top:65px;">
