...
//定义回调URL通用的URL
define('URL_CALLBACK', 'http://api.mimilove520.com/OAuth/Login?type=');

return array(
    //腾讯QQ登录配置
    'THINK_SDK_QQ'      => array(
        'APP_KEY'       => '101316078', //应用注册成功后分配的 APP ID
        'APP_SECRET'    => '870fd018901757d3f7ff6ba9fbe37245', //应用注册成功后分配的KEY
    ...
    'THINK_SDK_SINA'    => array(
        'APP_KEY'       => '2864395465', //应用注册成功后分配的 APP ID
        'APP_SECRET'    => 'a06f51ab3fcb838f03736782ab2eddcb',//应用注册成功后分配的KEY
